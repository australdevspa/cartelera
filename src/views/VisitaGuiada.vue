  ...
  <section>
    <div class="uk-section espacios-pad">
      <div class="uk-container uk-container-center uk-text-center pad-evento">
        <div>
          <a href="javascript:window.history.back();" class=" uk-align-left uk-button boton-secundario boton-pequeño"><span uk-icon="chevron-left" class="bold-icon"></span> Volver atrás</a>
          
          <div class="uk-align-right">
            <div v-if="camara_encendida">
              <a href="#" class="uk-button boton-secundario" @click.prevent="apagarCamara()">Desactivar Scanner QR</a>
            </div>
            <div v-else>
              <a href="#" v-scroll-to="'#abajo'" class="uk-button boton-secundario" @click.prevent="encenderCamara()">Activar Scanner QR</a>
            </div>
          </div>
        </div>
        ...
        <div class="x">
          ...
          <div v-else>
            ...
            <div v-if="this.floor !== 0">
              <a href="#" class="uk-button boton-secundario boton-pequeño" @click.prevent="cargarPiso(0)"><span uk-icon="chevron-left" class="bold-icon"></span> Pisos</a>
            </div>
