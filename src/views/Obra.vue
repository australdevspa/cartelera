      ...
      <div v-if="estado_traduccion_obra === false">
        <div class="uk-card uk-card-default parent">
          ...
          <div v-if="evento.video_url_tour !== null" style="padding: 30px 10px;">
            <iframe width="100%" height="640" style="width: 100%; height: 640px; border: none; max-width: 100%;" frameborder="0" allow="vr,gyroscope,accelerometer,fullscreen" scrolling="no" allowfullscreen="true" src="https://kuula.co/share/collection/7l5Fk?fs=1&vr=0&thumbs=1&chromeless=0&logo=0"></iframe>
          </div>
